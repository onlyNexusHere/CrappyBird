...
public class ShapeCollisionChecker extends BaseCollisionChecker {
	...
	/**
	 * Calls through to {@link org.andengine.util.algorithm.collision.ShapeCollisionChecker#checkCollisionSub(float[], int, int, int, int, int, float[], int, int, int, int)} with the default parameters internally used by different AndEngine primitives.
	 * @param pVerticesA
	...
	/**
	 * Calls through to {@link org.andengine.util.algorithm.collision.ShapeCollisionChecker#checkContains(float[], int, int, int, int, float, float)} with the default parameters internally used by different AndEngine primitives.
	 *
	 * @param pVertices
