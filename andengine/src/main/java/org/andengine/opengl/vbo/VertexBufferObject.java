...
public abstract class VertexBufferObject implements IVertexBufferObject {
	 ...
	 * @param pVertexBufferObjectAttributes to be automatically enabled on the {@link ShaderProgram} used in {@link org.andengine.opengl.vbo.VertexBufferObject#bind(ShaderProgram)}.
	 */
