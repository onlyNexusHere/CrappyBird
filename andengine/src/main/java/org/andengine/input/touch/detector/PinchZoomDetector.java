...
public class PinchZoomDetector extends BaseDetector {
	...
	/**
	 * When {@link org.andengine.input.touch.detector.PinchZoomDetector#isZooming()} this method will call through to {@link org.andengine.input.touch.detector.PinchZoomDetector.IPinchZoomDetectorListener#onPinchZoomFinished(org.andengine.input.touch.detector.PinchZoomDetector, TouchEvent, float)}.
	 */
	@Override
	public void reset() {
