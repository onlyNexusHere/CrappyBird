...
public class HoldDetector extends BaseDetector {
	...
	/**
	 * When {@link org.andengine.input.touch.detector.HoldDetector#isHolding()} this method will call through to {@link org.andengine.input.touch.detector.HoldDetector.IHoldDetectorListener#onHoldFinished(org.andengine.input.touch.detector.HoldDetector, long, int, float, float).
	 */
	@Override
	public void reset() {
		if(this.mTriggering) {
