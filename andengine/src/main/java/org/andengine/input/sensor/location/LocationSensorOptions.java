...
public class LocationSensorOptions extends Criteria {
	...
	/**
	 * @see {@link org.andengine.input.sensor.location.LocationSensorOptions#setAccuracy(int)},
	 *      {@link org.andengine.input.sensor.location.LocationSensorOptions#setAltitudeRequired(boolean)},
	 *      {@link org.andengine.input.sensor.location.LocationSensorOptions#setBearingRequired(boolean)},
	 *      {@link org.andengine.input.sensor.location.LocationSensorOptions#setCostAllowed(boolean)},
	 *      {@link org.andengine.input.sensor.location.LocationSensorOptions#setEnabledOnly(boolean)},
	 *      {@link org.andengine.input.sensor.location.LocationSensorOptions#setMinimumTriggerDistance(long)},
	 *      {@link org.andengine.input.sensor.location.LocationSensorOptions#setMinimumTriggerTime(long)},
	 *      {@link org.andengine.input.sensor.location.LocationSensorOptions#setPowerRequirement(int)},
	 *      {@link org.andengine.input.sensor.location.LocationSensorOptions#setSpeedRequired(boolean)}.
	 */
